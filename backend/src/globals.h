...
#define MAX_INNER_HEADER_BIT_SIZE 248
#define MAX_HEADER_BIT_SIZE 152
#define MAX_HEADER_BYTE_SIZE 19
#define HEADER_TIME_BIT_POS 40
...
#define OMNIPOTENT_SET 0x01057880
#define MIN_SET 0x01000000
